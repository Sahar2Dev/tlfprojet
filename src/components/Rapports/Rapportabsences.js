...
<h3 style={{color:"white"}}>Importer Rapport d'abscence</h3>
</div> 
          ...
          {loginemploye ? <div className="form-group pt-4" style={{ marginLeft: "45%", marginRight: "55%" }}>
            <a className="btn btn-primary" style={{ color: "white" }} data-dismiss="modal" onClick={(e) => { SelectRapportAbsences(date1, date2, e); handleToggle() }}>Importer</a></div> : <>
