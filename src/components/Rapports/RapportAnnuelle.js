...
<h3 style={{color:"white"}}>Importer Rapport Annuel</h3>
    </div>
          <form>
          ...
          {loginemploye ? <div className="form-group pt-4" style={{ marginLeft: "45%", marginRight: "55%" }}>
            <a className="btn btn-primary" style={{ color: "white" }} data-dismiss="modal" onClick={(e) => { SelectRaAnnuelle(date1, date2, e); handleToggle() }}>Importer</a></div> : <>
...
{dropdown}
   ...
   <Backdrop  open={openn}>
      ...
      <div className='card'>
<div className='card-header' style={{backgroundColor:"#5ac2df"}}>
      <h3 style={{color:"white"}}>Rapport Annuel de {date1} à {date2}</h3>
      </div>
    <hr/>
