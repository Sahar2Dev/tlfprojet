...
function CrudHorraire() {
  ...
  if(Object.keys(userinfo).length !=0){ 
    var view_horaire_rh=test['view_horaire_rh']
         ...
         {horaires.length==0?"":       <table className="display" id="horairetable">
                  <thead className="thead-light">
                    <tr>
                      ...
                      <th style={{width:"2%"}} scope="col">Jr Trav</th>
                    ...
                    {horaires.map(horaire =>
                      <tr key={horaire.id}>
                        ...
                        <td>
                          ...
                          {view_horaire_rh==true?"":        <>           <a onClick={() => SelectHoraire(horaire.id)} data-toggle="modal" data-target="#updateHoraire" ><EditIcon
